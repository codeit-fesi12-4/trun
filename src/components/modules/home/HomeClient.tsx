...
const HomeClient = () => (
  <div className="flex flex-col">
    {/* 히어로 섹션 */}
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-green-50 via-white to-green-50 px-6 text-center">
